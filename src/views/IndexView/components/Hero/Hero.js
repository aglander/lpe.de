...
import StartImage from "assets/images/LPE_Start.jpg";
...
const Hero = ({ themeMode = 'light', className, ...rest }) => {
  ...
  const subtitle = 'Ich berate Sie gerne persönlich, bei uns im Büro, bei Ihnen vor Ort und selbstverständlich, für Sie besonders bequem, auch per Telefon und Videoberatung.';
